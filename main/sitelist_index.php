	...
	<a rel="facebox" href="addprojectsite_genm.php"><Button type="submit" class="btn btn-info" style="float:right; width:230px; height:35px;" /><i class="icon-plus-sign icon-large"></i> Add Project Site</button></a><br><br>
	<table class="hoverTable" id="resultTable" data-responsive="table" style="text-align: left;">
		...
		<tbody>
			...
			<td><a rel="facebox" title="Click to edit the project site" href="editprojectsite_genm.php?id=<?php echo $row['site_id']; ?>"><button class="btn btn-warning"><i class="icon-edit"></i> </button> </a>
			<a href="#" id="<?php echo $row['site_id']; ?>" class="delbutton" title="Click to Delete the project site"><button class="btn btn-danger"><i class="icon-trash"></i></button></a></td>
			</tr>
				<?php
					}
				?>
